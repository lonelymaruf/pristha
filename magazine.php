...
<html>
<head>
<title><?php echo $website_name; ?> | Mobile and Tablets</title>
...
<h1>Recent Listings <em>in Mobile and Tablets</em></h1>

<?php

// Target the table.
$listings = mysqli_query($connect,"SELECT * FROM mobiletablets ORDER BY id DESC");
