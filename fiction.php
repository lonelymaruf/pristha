...
<html>
<head>
<title><?php echo $website_name; ?> | Computers Science</title>
    ...
    <div class="container">
      ...
      <div class="row header"><!-- Begin Header -->
        ...
        <div class="span7"><!--Begin page content column-->
            ...
            <h2 class="title-bg">Recent books in Computer Science</h2>
<?php

// Target the table.
$listings = mysqli_query($connect,"SELECT * FROM fiction ORDER BY id DESC");
