...
<html>
<head>
<title><?php echo $website_name; ?> | Entertainment</title>
...
<h1> Lasted used<em> Reference Books</em></h1>

<?php

// Target the table.
$listings = mysqli_query($connect,"SELECT * FROM reference ORDER BY id DESC");
